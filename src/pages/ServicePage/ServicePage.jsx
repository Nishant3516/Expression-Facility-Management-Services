...
import lanudryHeroImage from '../../assets/services/laundry.jpg'
...
import securityHeroImage from '../../assets/services/security_hero_image.jpg'
...
const ServicePage = () => {
  ...
  const serviceData = [
    ...
    { id: 2, title: 'Security Services', description: "Our top-tier security services are designed to provide a safe and secure environment for your healthcare facility. With highly trained security personnel, we offer 24/7 surveillance, access control, and emergency response. We prioritize patient and staff safety by implementing customized security plans that align with your facility's needs. Our team ensures the protection of both property and personnel while maintaining a welcoming atmosphere. Rely on our expert security services to safeguard your healthcare environment with professionalism and discretion.", serviceList : [
      ...
      { title: "Home/Office", icon: officeImage },
      { title: "Factory", icon: factoryImage },
    ],backgroundImage: securityHeroImage, features: {"":"Skilled", "":"Adhere to Hygiene", "":"Avoid Invading Personal Space"}},
    { id: 3, title: 'Pest Control Services', description: "Our professional pest control services ensure a hygienic and pest-free environment for your healthcare facility. We use safe, effective treatments to eliminate common pests while prioritizing the health and safety of patients and staff. Our team is trained in handling sensitive environments, offering discreet and timely pest management solutions. Whether it's for routine inspections or emergency treatments, we tailor our services to meet your needs. Trust us to maintain a clean and pest-free healthcare setting with our reliable, eco-friendly pest control services.", serviceList : [
      { title: "Healthcare", icon: healthImage },
        { title: "Hotels & Restaurants", icon: hotelImage },
        { title: "Resorts", icon: resortImage },
        { title: "Malls", icon: shoppingImage },
    ...
    { id: 6, title: 'Ward Boy Services', description: "Our ward boy services provide essential support to healthcare facilities by ensuring smooth operations and enhancing patient care. Our trained staff assist with daily tasks such as patient mobility, delivering meals, maintaining cleanliness in patient rooms, and offering general assistance to healthcare teams. With a focus on compassion and efficiency, our ward boys contribute to a comfortable and well-organized environment for patients and staff. Rely on our dedicated professionals to provide reliable support, allowing your medical team to focus on delivering top-quality healthcare.", serviceList : [
      { title: "Healthcare", icon: healthImage },
        { title: "Hotels & Restaurants", icon: hotelImage },
        { title: "Resorts", icon: resortImage },
        { title: "Malls", icon: shoppingImage },
